...
public class FundingAccountFactoryAccountView extends TestBase {
	...
	@FindBy(xpath="//div[starts-with(@id,'cardForm')]//div[starts-with(@class,'x-form-element')]//div[contains(@class,'x-trigger-wrap-focus')]//img")
	private WebElement dropdown_CreditDebit;
	
	

	@FindBy(xpath="(//div[starts-with(@id,'cardForm')]//div[starts-with(@class,'x-form-element')]//div[contains(@class,'x-form-field-trigger-wrap')]//img)[2]")
	private WebElement dropdown_CardType;

	@FindBy(xpath="(//div[starts-with(@id,'cardForm')]//div[starts-with(@class,'x-form-element')]//div[contains(@class,'x-form-field-trigger-wrap')]//img)[3]")
