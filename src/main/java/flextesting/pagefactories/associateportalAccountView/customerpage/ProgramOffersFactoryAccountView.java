...
public class ProgramOffersFactoryAccountView extends TestBase {
	
	private String  xpathOfAvailableOffer = "//div[starts-with(@class,'x-window-bwrap')]//div[@id='paymentPromiseOfferWindow']//div[contains(@class,'x-grid3-row-first')]";
	private String  xpathOfAccount = "(//div[starts-with(@class,'x-window-bwrap')]//div[contains(@class,'x-grid3-body')])[2]";
	...
	@FindBy(xpath = "(//div[starts-with(@class,'x-window-bwrap')]//img[contains(@class,'x-form-arrow-trigger')])[2]")
	...
	public void select_The_Any_Account_FromList() throws InterruptedException {
		List<WebElement> findElements = getDriver().findElements(By.xpath("(//div[starts-with(@class,'x-window-bwrap')]//div[contains(@class,'x-grid3-row-alt')])"));
		System.out.println("//div[starts-with(@class,'x-window-bwrap')]//div[contains(@class,'x-grid3-row-alt')])["+findElements.size()+"]");
		clickByXpath(getDriver(), "(//div[starts-with(@class,'x-window-bwrap')]//div[contains(@class,'x-grid3-row-alt')])["+findElements.size()+"]");
		Thread.sleep(3000);
	}
	...
	public void clickOnAcceptedProgramOffer() throws InterruptedException {
        clickByXpath(getDriver(), "(//div[starts-with(@class,'x-window-bwrap')]//div[contains(@class,'x-grid3-col-1')])[5]");
		Thread.sleep(3000);
	}
	...
	public void clickOnOkButton() throws InterruptedException {
		clickByXpath(getDriver(), "(//div[starts-with(@class,'x-window-bwrap')]//button[contains(text(),'OK')])[2]");
		Thread.sleep(4000);
	}
	...
	public void i_Select_any_one_payment_and_click_on_Update_Payment_button() throws Throwable {
		clickByXpath(getDriver(), "(//div[starts-with(@class,'x-window-bwrap')]//div[contains(@class,'x-grid3-row-first')])[5]");
