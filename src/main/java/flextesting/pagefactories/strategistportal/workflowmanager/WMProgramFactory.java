 ...
 * @author Shiyi Chen
 */
public class WMProgramFactory extends ProgramFactory {

	@FindBy(xpath="//div[starts-with(@id,'workflowrepository') and contains(@id,'-body')]//div[starts-with(@id,'programactiongrid')]//div[starts-with(@id,'buttongroup')]//span[text()='Add']//parent::button[1]")
	private WebElement btn_Add_tab_Programs;
	
	@FindBy(xpath="//div[starts-with(@id,'workflowrepository') and contains(@id,'-body')]//div[starts-with(@id,'programactiongrid')]//div[starts-with(@id,'buttongroup')]//span[text()='Delete']//parent::button[1]")
	private WebElement btn_Delete_tab_Programs;
	
	private By locator_element_hiddenWindow_ProgramAvailableTo = By.xpath("//div[starts-with(@id,'workflowprogramactionedit')]//following-sibling::div[starts-with(@id,'window') and contains(@class,'x-hide-offsets')]");

	@FindBy(xpath="//div[starts-with(@id,'workflowprogramactionedit')]//following-sibling::div[starts-with(@id,'window')]//img[@class='x-tool-close']")
	private WebElement btn_close_ProgramAvailableTo;

	@FindBy(xpath="//div[starts-with(@id,'workflowprogramactionedit') and contains(@id,'body')]//span[text()='Save']//parent::button[1]")
	...
	public void choose_Program(String programName) {
		String xpath = "//div[starts-with(@id,'programactiongrid')]//div[contains(@class,'x-grid-cell-inner') and text()='"+programName+"']";
