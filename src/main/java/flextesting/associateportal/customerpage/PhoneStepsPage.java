...
public class PhoneStepsPage extends TestBase {
	static Logger log = Logger.getLogger(PhoneStepsPage.class);
	...
	public PhoneSteps() {
		...
		log.info("Phone Info Retrieved from DB: Phone Type | Country Code | Phone # : " + Arrays.toString(phoneInfo));
...
//	public void i_select_as_the_Phone_Number_Type(String arg1) throws Throwable {
	...
	public void i_select_a_Phone_Number_Type() throws Throwable {
		...
		log.info("Phone Type retrieved from DB: " + phoneType);
...
//		Utils.clearAndEnter(getDriver(), "//input[(@name='phoneNumber') or (@name='maskPhoneNumber')]", ClientProvider.getClient().getRandomPhoneNumber());
	...
	public void i_select_for_the_Express_Consent_Call(String arg1) throws Throwable {
		commonElementsFactory.arrowTrigger("Express Consent (Call):");
	...
	public void i_select_for_the_Express_Consent_SMS(String arg1) throws Throwable {
		commonElementsFactory.arrowTrigger("Express Consent (SMS):");
		commonElementsFactory.chooseAnOptionByName(arg1);
	}
...
//		Utils.clickByXpath(driver, "//input[(@name='phoneNumber') or (@name='maskPhoneNumber')]");
	...
	public boolean i_should_see_the_phone_created() throws Throwable {
	...
	public boolean i_should_see_the_phone_number_deleted() throws Throwable {
